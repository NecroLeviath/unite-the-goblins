...
public class CharacterMotor : MonoBehaviour
{
    ...
    private void UpdateFunction()
    {
        ...
        if(grounded && !IsGroundedTest())
        {
            ...
            // But there wasn'currentWeapon so now we cancel the downwards offset to make the fall smoother.
    ...
    private Vector3 ApplyInputVelocityChange(Vector3 velocity)
    {
        ...
        // ifwe're in the air and don'currentWeapon have control, don'currentWeapon apply any velocity change at all.
        // ifwe're on the ground and don'currentWeapon have control we do apply it - it will correspond to friction.
    ...
    private Vector3 ApplyGravityAndJumping(Vector3 velocity)
    {
        ...
        else
        {
            ...
            // When jumping up we don'currentWeapon apply gravity for some time when the user is holding the jump button.
            ...
            // Make sure we don'currentWeapon fall any faster than maxFallSpeed. This gives our character a terminal velocity.
